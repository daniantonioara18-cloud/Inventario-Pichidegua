...
-- CAMBIO APLICADO: Sin ubicaciÃ³n fÃ­sica
...
-- ================================================================
-- 4. FICHAS TÃ‰CNICAS (Detalles especÃ­ficos)
-- ================================================================
...
INSERT INTO categoria (nombre, descripcion) VALUES ('TecnologÃ­a', 'Equipos informÃ¡ticos');
...
-- Item 2: Silla
INSERT INTO item (codigo_interno, nombre, modelo, descripcion, vida_util_meses, id_subcategoria, id_adquisicion, activo)
VALUES ('MUE-001', 'Silla ErgonÃ³mica', 'X500', 'Silla Gerencia', 60, 2, 1, true);

-- Ficha Notebook (AquÃ­ va el serial)
...
VALUES (2, 'Malla y PlÃ¡stico', 'Negro');


INSERT INTO marca (nombre) VALUES
('HP'), ('Dell'), ('Lenovo'), ('Samsung'), ('LG'), ('GenÃ©rica')
...
VALUES
 ('Juan PÃ©rez', 'juan.perez@muni.cl', 'Encargado InformÃ¡tica', (SELECT id_area FROM inventario.area_municipal WHERE nombre='InformÃ¡tica')),
 ('MarÃ­a Soto', 'maria.soto@muni.cl', 'Encargada Bodega', 4),
 ('Pedro DÃ­az', 'pedro.diaz@muni.cl', 'Administrativo', (SELECT id_area FROM inventario.area_municipal WHERE nombre='AdministraciÃ³n'))
...
-- 0.3) FK movimiento -> tipo_movimiento (si aÃºn no existe)
...
-- usuarios (con Ã¡rea opcional)
INSERT INTO inventario.usuario (nombre, email, cargo, id_area)
VALUES
('Juan PÃ©rez', 'juan.perez@muni.cl', 'Encargado', (SELECT id_area FROM inventario.area_municipal WHERE nombre='InformÃ¡tica')),
('MarÃ­a Soto', 'maria.soto@muni.cl', 'Administrativa', (SELECT id_area FROM inventario.area_municipal WHERE nombre='Finanzas')),
('Pedro Rojas', 'pedro.rojas@muni.cl', 'TÃ©cnico', 2);
