...
-- agregar user administrador
INSERT INTO inventario.user_adm (nombre, email, password_hash, cargo)
VALUES (
  'Juan Administrador', 
  'juan@muni.cl', 
  -- Este texto largo es el HASH EXACTO de la contraseña: admin123
  '$2a$10$w.9Jz5xM75b1WjI4t3X5c.U2gU6a5/1X31.o4l2G3G.m9E21Uq/eW', 
  'Admin BD'
);